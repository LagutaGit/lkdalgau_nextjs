          ...
          {newsData.map((news) => (
            ...
            >
              <Image
                ...
                height={400}
              />
              <div className="news-text m-2 flex flex-col justify-between">
                <div className="date-news p-2 pt-1">{news.date}</div>
                <div className="text-news p-2 line-clamp-3 mt-2">{news.text}</div>
                <Link className="text-center" href={`/event/news/${news.id}`}>
                  <Button
